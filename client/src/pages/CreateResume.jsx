...
const RESUME_PROMPT = `__ASK__
										Create a resume in the provided LATEX resume format using the form data provided

										__CONTEXT__
										- You are building a resume for a job posting based off the form data. 
